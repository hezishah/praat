...
struct _Label {
  ...
  int id;
  _Label(const char* txt);
  _Label(void (*draw_cmd)(Render,int id,int y_off),int id=0);
  _Label(const char *txt,void (*dr)(Render,int id,int y_off),int id=0);
...
struct Button:WinBase {
  ...
  _Label label;
  void (*cmd)(Button*);
  Button(WinBase *pw,Style,Rect,_Label lab,void (*cmd)(Button*),const char *title=0);
  void draw();
};
...
struct RExtButton:WinBase {
  ...
  Style style;
  _Label label;
  RExtButton(WinBase *pw,Style,Rect,_Label,int id);
  void draw();
};
...
struct ExtRButCtrl {
  ...
  void reset();
  RExtButton *add_extrbut(WinBase *pw,Rect,_Label lab,int id);
};
...
struct CheckBox:WinBase {
  ...
  Style style;
  void (*cmd)(CheckBox*);
  CheckBox(WinBase *pw,Style,Rect,_Label lab,void (*cmd)(CheckBox*));
  bool &value();
  void draw();
