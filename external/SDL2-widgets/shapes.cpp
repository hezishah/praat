...
static void set(SDL_Rect &r,int x,int y,int w,int h) {
...
void ellipseColor(Render rend,int xc, int yc, int rx, int ry,Uint32 col) {
    /* Todo - make the ellipse not filled */
    set(rend,col);
    int x, y;
    int p1, p2, rx2, ry2;
    rx2 = rx*rx;
